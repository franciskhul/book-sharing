...
import { ListItemText, ListItemIcon, ListSubheader, ListItemButton, Theme } from '@mui/material';
// utils
import cssStyles from '../../../utils/cssStyles';
// config 
import { NAVBAR, ICON } from '../../../config';

interface ListItemButtonProp {
    active: boolean;
    theme?: Theme;
    depth: number
}
...
})<ListItemButtonProp>(({ active, depth, theme }) => ({
    position: 'relative',
